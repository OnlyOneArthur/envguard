"""Secret detection patterns adapted from gitleaks v8 + real-world key formats.
...
PATTERNS = [
    ...
    ("openai-project-key", "OpenAI Project API Key", re.compile(r"\bsk-proj-[a-zA-Z0-9_\-]{40,}\b"), 3.0),
    ("openai-service-key", "OpenAI Service Account Key", re.compile(r"\bsk-svcacct-[a-zA-Z0-9_\-]{40,}\b"), 3.0),
    ...
    ("vercel-token", "Vercel Access Token", re.compile(r"\bvercel_[a-zA-Z0-9]{24,}\b"), 3.0),
